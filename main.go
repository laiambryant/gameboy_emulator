...
func (g *Game) Update() error {input := emulator.InputState{
...
func (g *Game) Draw(screen *ebiten.Image) {	if g.emu.SwapBuffers() {
...
func (g *Game) Layout(outsideWidth, outsideHeight int) (int, int) {	return 160 * scale, 144 * scale
}
